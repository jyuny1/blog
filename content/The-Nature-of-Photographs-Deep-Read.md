...
> 1. **平面 (Plane)**：對抗 3D 轉 2D 的扁平化，奪回**==空間感的操控權==**> 2.**視點 (POV)**：利用單眼視覺的重疊，奪回**==物體關係的定義權==**> 3.**邊框 (Frame) **：對抗無限延伸的現實，奪回**==視覺內容的篩選權==**> 4.**時間 (Time) **：對抗流動不息的時間，奪回**==時間形態的改造權==**> 5.**聚焦 (Focus)**：對抗人眼的自由掃描，奪回**==觀者目光的指令權==**
